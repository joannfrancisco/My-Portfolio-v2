    ...
    <div id="smooth-wrapper" className="relative">
      ...
      <div id="smooth-content">
        <div className="w-screen max-w-screen-2xl mx-auto px-6 sm:px-10 md:px-15 lg:px-30 xl:px-50">
          ...
          {/* title */}
          <div>
            <h1 className="text-4xl lg:text-6xl font-header text-(--granola)">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-1 lg:gap-10">
            ...
            <div className="">
              <div className="flex items-center mb-5">
                <h1
                  className="w-50 text-lg font-extrabold text-(--granola) pr-1 md:pr-0"
          ...
          <div className="mt-5">
            <h1
              className="w-[170px] mb-3 text-lg font-extrabold text-(--granola)"
              style={{ fontFamily: "var(--font-archivo)" }}
            >
            ...
            <h1
              className="w-[170px] mb-3 mt-5 lg:mt-10 text-lg font-extrabold text-(--granola)"
              style={{ fontFamily: "var(--font-archivo)" }}
            >
