...
//                 <h1 className="w-40 font-bold text-base text-(--granola)">
//                   CATEGORY
//                 </h1>
//                 <ul className="text-base leading-relaxed pl-1 w-[200px]">
...
//                 project, I redesigned their existing homepage to create a more
//                 modern, engaging, and visually dynamic experience.
//               </p>
...
//           {/* figma files */}
//           <div className="mt-5">
//             <h1 className="w-[170px] font-bold text-base mb-3 text-(--granola)">
//               HOMEPAGE
//             </h1>
//             <FigmaFiles
//               src="/images/projects/granola/homepage.png"
//               alt="homepage"
//             />
//             <FigmaFiles
//               src="/images/projects/granola/homepage.png"
...
const ProjectGranola = () => {
  ...
  return (
    <div id="smooth-wrapper" className="relative">
      {/* Fixed Diagonal Oblong Gradient Background */}
      {/* <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
        <div
          className="absolute top-1/4 -left-1/4 w-[800px] h-[400px] rotate-45 opacity-30 blur-3xl animate-pulse"
          style={{
            background:
              "radial-gradient(ellipse at center, #A855F766 0%, #C4B5FD33 40%, transparent 70%)",
            animation: "pulse 8s ease-in-out infinite",
          }}
        />
        <div
          className="absolute bottom-1/4 -right-1/4 w-[900px] h-[450px] -rotate-45 opacity-25 blur-3xl"
          style={{
            background:
              "radial-gradient(ellipse at center, #A855F766 0%, #C4B5FD33 40%, transparent 70%)",
      ...
      {/* Centered Diagonal Oblong Gradient Background */}
      <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
        <div
