            ...
            <div className="flex flex-col lg:flex-row justify-between items-start gap-7 lg:gap-20">
              <div className="flex gap-5 ">
                ...
                <a
                  ...
                  className="text-base md:text-xl font-normal inline-flex w-fit items-center relative group"
                >
              ...
              <div className="flex  gap-5">
                ...
                <div className="text-base md:text-xl font-normal flex flex-col gap-2">
                  <a
