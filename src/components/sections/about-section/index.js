...
//       id="about"
//       // ref={sectionRef}
//       className="  max-w-4xl mx-auto py-16 xl:py-0 w-full h-full relative border-y border-(--foreground)/15 bg-amber-200"
//     >
//       <div className="">
...
//               Hello! I&apos;m{" "}
//               <span className="font-semibold">Jo Ann Francisco</span>, but you
//               can call me Ann.{" "}
//             </p>
...
//             </p>
//             <p className="text-base md:text-lg font-light text-left leading-relaxed mt-5  text-(--foreground)/80">
//               My mission is simple: give you a high-performance website that
//               wins more customers and gives you the competitive edge you
//               deserve.
//             </p>
