...
//         <div className="max-w-screen-2xl mx-auto px-4 md:px-10 py-2 lg:py-6 flex items-center justify-between bg-(--background)/40 md:bg-(--background)/0 backdrop-blur-xs md:backdrop-blur-none">
//           <Link
//             href="/"
...
const Menu = () => {
  ...
  return (
    <div>
      <nav className="fixed top-0 left-0 right-0 z-50 ">
        <div className="max-w-screen-2xl mx-auto px-4 md:px-10 py-2 lg:py-6 flex items-center justify-between  backdrop-blur-xs md:backdrop-blur-none">
          <Link
            href="/"
            className="text-2xl hover:opacity-80 transition-opacity font-logo"
          >
